...
YY4 = tf.nn.dropout(x=Y4, keep_prob=pkeep)
Ylogits = tf.matmul(a=YY4, b=W5) + B5
...
def training_step(i, update_test_data, update_train_data):
    ...
    sess.run(fetches=train_step, feed_dict={X: batch_X, Y_: batch_Y, lr: learning_rate, pkeep: 0.75})
